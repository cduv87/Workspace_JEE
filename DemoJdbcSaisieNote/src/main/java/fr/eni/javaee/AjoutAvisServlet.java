...
/**
 * Servlet utilisé pour la fonctionnalité d'ajout d'avis on utilse "" comme url
 * donc ce servlet sera "mappé" à l'url de base
 */
@WebServlet("")
public class AjoutAvisServlet extends HttpServlet {
	...
	/**
	 * doGet : va être appelé quand on rentre l'url de l'application dans un nouvel
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			 ...
			 * bien passée
			 **/
			// 3 - j'ajoute un attribut de requête "messageConfirmation" pour permettre à la
			// JSP d'afficher un message.
			...
			// alors j'ajoute un attribut de requête "messageErreur" pour permettre à la JSP
